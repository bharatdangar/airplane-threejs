...
function loadModel()
{
	...
	function onModelLoaded() {
		object.traverse( function ( child ) {
			let mat = new THREE.MeshStandardMaterial( { color: 0x171511, metalness: 0.9, roughness: 0.35, flatShading: true } );
			child.material = mat;
		});
	...
	loader.load( '../public/1405+Plane_1.obj', function ( obj ) { object = obj; });
}
